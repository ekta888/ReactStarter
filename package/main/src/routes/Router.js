...
const Cdr = Loadable(lazy(() => import('../views/cdr/Cdr')));
...
const ThemeRoutes = [
  {
    ...
    children: [
      ...
      { path: '/cdr/cdr', name: 'Analytical', exact: true, element: <Cdr /> },
      {
      ...
      { path: '/dashboards/dashboard3', name: 'Modern', exact: true, element: <Dashboard3 /> },
      { path: '/dashboards/dashboard4', name: 'Modern', exact: true, element: <Dashboard4 /> },
      { path: '/dashboards/dashboard5', name: 'Modern', exact: true, element: <Dashboard5 /> },
      { path: '/dashboards/dashboard6', name: 'Modern', exact: true, element: <Dashboard6 /> },
